...
public class MultipleTransferTestNG {
	...
	@Test
	public void MultipleTransfer() throws InterruptedException {
		...
		Thread.sleep(2000);
		Thread.sleep(2000);
		driver.findElement(By.xpath("//a[contains(text(),'Multiple Transfer')]")).click();
		Thread.sleep(2000);
